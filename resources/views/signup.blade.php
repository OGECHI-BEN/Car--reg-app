...
<h1 class="text-center  text-yellow-700  font-extrabold text-xl m-auto py-[20px] md:py-[50px]">Welcome back please sign Up</h1>
    <form action="{{route('register-user')}}" method="POST" class="max-w-sm mx-auto">
        ...
        <div class="mb-3">
            ...
            <input type="email" id="email" name="email" required class="bg-gray-200 border border-gray-300 text-gray-950 text-lg focus:ring-gray-800 block w-full p-3 " name="email" value="{{old('email')}}">
        ...
        <div class="mb-3">
            ...
            <input type="password" id="password" name="password" required class="bg-gray-200 border border-gray-300 text-gray-950 text-lg focus:ring-gray-800 block w-full p-3 ">
            <span class="text-red-500">@error('password'){{$message}} @enderror</span>
        </div> 
                <!---password confirmation--->
        <div class="mb-3">
            <label for="confirm_password" class=" block mb-2 text-sm text-gray-900 "> Confirm password:</label>
            <input type="password" id="confirm_password" name="password_confirmation" value="{{old('password_confirmation')}}" required class="bg-gray-200 border border-gray-300 text-gray-950 text-lg focus:ring-gray-800 block w-full p-3 ">
        </div> 
